...
// import EstimateStatus from '../../Modal/EstimateStatus/EstimateStatus';
        ...
        <NewEstimateStyle>
            <Box className='new-customer custom-radius'>
                <Box className='create-cust' sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Typography variant='h2' className="text-dark-black">Add Estimate</Typography>
                </Box>
            ...
            {/* <EstimateStatus statusOpen={statusOpen} setStatusOpen={setStatusOpen} /> */}
        </NewEstimateStyle>
    )
}
